...
const PromptCard = ({ post, handleTagClick, 
  handleEdit, handleDelete }) => {
    ...
    const handleProfileClick = () => {
      ...
      //router.push(`/profile/${post?._id.toString()}`)
  }

    const [copied, setCopied] = useState("");

    //console.log("this is a post from prompt card "+post._id);
  ...
  return (
    <div className="prompt_card">
      ...
      gap-5">
        <div className="flex-1 flex jsutify-start 
      ...
      <p className="font-inter text-sm blue-gradient
      cursor-pointer"
